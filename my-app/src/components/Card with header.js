...
import Info from "./With large images";
  ...
  return (
    <div className=" overflow-hidden shadow rounded-lg divide-y divide-gray-200 w-full  photo  ">
      ...
      <div className="flex justify-between mt-3">
       <InputElement name="make"/>
       <InputElement name="model"/>
       <InputElement name="Year"/>
       <InputElement name="Sport"/>
       <InputElement name="Milage"/>
       <InputElement name="By   Date           "/>
       <div className="flex mt-2">
       <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-5  text-gray-500" viewBox="0 0 20 20" fill="currentColor">
