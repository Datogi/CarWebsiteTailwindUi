                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-lg leading-6 font-medium space-y-1">
                      <h3>{person.name} <span className="text-indigo-600 text-lg ml-4 font-bold">{person.price}</span></h3>
                      <p className="text-gray-600 text-sm">{person.role}</p>
                    </div>
                    <div className=" flex justify-between">
                    <button className=" rounded-full bg-gray-300 text-black px-4 py-2">Button1</button>
                        <button className=" rounded-full bg-gray-300 text-black px-4 py-2">Button1</button>
                        <button className=" rounded-full bg-gray-300 text-black px-4 py-2">Button1</button>
                    </div>
                    <ul  className="flex flex-col ">
                      ...
                      <li className="flex justify-between">
                       <h3  className="font-extralight">Est cost & Repairment</h3>
